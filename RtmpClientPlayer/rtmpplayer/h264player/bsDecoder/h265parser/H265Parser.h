...
// #define HIS_H265_PARSER EXTERNC __declspec(dllexport)	
// #else	// else BSRDVRSDK_EXPORTS
// #define HIS_H265_PARSER EXTERNC __declspec(dllimport)
...
#define DVXSDK_EXPORTS
#ifdef DVXSDK_EXPORTS
#define HIS_H265_PARSER __declspec(dllexport)	
#else	// else BSRDVRSDK_EXPORTS
#define HIS_H265_PARSER __declspec(dllimport)
#endif	// end BSRDVRSDK_EXPORTS
...
// gboolean     gst_h265_parser_sps_info( GstH265Parser *parser, 
// 												   GstH265SPS *sps, const guint8  *data, int len);

HIS_H265_PARSER GstH265Parser *gst_h265_parser_new(void);
HIS_H265_PARSER gboolean gst_h265_parser_sps_info( GstH265Parser *parser, GstH265SPS *sps, const guint8 *data, int len);
HIS_H265_PARSER void gst_h265_parser_free(GstH265Parser* parser);
